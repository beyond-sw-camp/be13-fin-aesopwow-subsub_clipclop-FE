...
/**
 * Displays a retention heatmap panel with dynamic data, including a title, description, and heatmap image.
 *
 * Renders loading and error states as appropriate. When data is available, shows the panel title, descriptive content, and a heatmap image.
 */
